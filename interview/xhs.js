/**
 ...
 @description 前端拉过来的加密函数
 @timeSnapshot 2024/1/16-15:45:43
 */
let document = {
    createElement: ()=>{
...
!function() {
    function B() {
        ...
        return function(C, I, H) {
            ...
            var T = function(B) {
                return B._ace_38c9c ? B._ace_936[B._ace_47589] ? B._ace_936[B._ace_47589] : B._ace_4de55 : B._ace_4de55;
                // if(B._ace_47589==="createElement") console.log(B)
                // if(B._ace_47589==="getAttribute") return html.getAttribute
...
// 不要写死，动态获取
let s = '/api/sns/web/unread_count', i
console.log(window._webmsxyw(s, i));

let decryptHeader = window._webmsxyw;

let requestPage = (xhr, url, total)=>{
...
// 发送请求，将 JSON 字符串放置在请求体中
xhr.send(jsonData);

}

let requestDetail = (url)=>{
